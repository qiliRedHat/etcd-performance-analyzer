...
try:
    ...
    from analysis.node_analyzer_performance_deepdrive import nodeDeepDriveAnalyzer
...
class NODEPerformanceDeepDriveResponse(MCPBaseModel):
...
@mcp.tool()
async def get_node_performance_deep_drive(
    duration: str = "1h",
    ...
    **Use Cases:**
    ...
    try:
        ...
        deep_drive_analyzer = nodeDeepDriveAnalyzer(ocp_auth, eff_duration)
